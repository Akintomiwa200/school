...
export const ROLE_ROUTES: Record<UserRole, { label: string; path: string; icon: string }[]> = {
  [UserRole.SUPER_ADMIN]: [
    ...
    { label: "Contact inbox", path: "/super-admin/contact", icon: "Mail" },
    { label: "Calendar", path: "/super-admin/calendar", icon: "Calendar" },
    { label: "Events", path: "/super-admin/events", icon: "PartyPopper" },
    { label: "Announcements", path: "/super-admin/announcements", icon: "Megaphone" },
    { label: "Support", path: "/super-admin/support", icon: "Headphones" },
  ...
  [UserRole.HR]: [
    ...
    { label: "Events", path: "/hr/events", icon: "PartyPopper" },
  ...
  [UserRole.RECEPTIONIST]: [
    ...
    { label: "Contact", path: "/receptionist/contact", icon: "Mail" },
